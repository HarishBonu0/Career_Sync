    ...
    return modules.map((module, idx) => {
      if (!module.readingMaterials || module.readingMaterials.length === 0) {
        ...
        return {
          ...
          readingMaterials: [
            {
              title: `${moduleTopic} overview`,
              source: 'Wikipedia',
              url: `https://en.wikipedia.org/wiki/Special:Search?search=${encodeURIComponent(moduleTopic)}`,
              difficulty: 'beginner',
              estimatedReadTime: idx < 3 ? '20 mins' : '30 mins',
            },
            {
              title: `${moduleTopic} documentation`,
              source: 'Google Search',
              url: `https://www.google.com/search?q=${encodeURIComponent(`${moduleTopic} official documentation`)}`,
              difficulty: 'intermediate',
              estimatedReadTime: '25 mins',
            },
            {
              title: `${moduleTopic} tutorial`,
              source: 'YouTube',
              url: `https://www.youtube.com/results?search_query=${encodeURIComponent(`${moduleTopic} tutorial`)}`,
              difficulty: 'beginner',
              estimatedReadTime: '15 mins',
            },
            {
              title: `${moduleTopic} learning guide`,
              source: 'Google Search',
              url: `https://www.google.com/search?q=${encodeURIComponent(`${moduleTopic} learning guide`)}`,
              difficulty: 'intermediate',
